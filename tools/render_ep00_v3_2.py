#!/usr/bin/env python3
"""
tools/render_ep00_v3_2.py
Renders Nemi Episode 00 V3.2 ("Wait, Listen to Me"):
...
4. Exports: episodes/ep00_introduction/previews/EP00_Introduction_V3_2_preview.mp4
5. Extracts verification frames for visual audit into v3_2_audit/.
"""
...
AUDIT_DIR = os.path.join(PREVIEWS_DIR, "v3_2_audit")
os.makedirs(PREVIEWS_DIR, exist_ok=True)
os.makedirs(AUDIT_DIR, exist_ok=True)

MASTER_AUDIO = os.path.join(BASE_DIR, "episodes", "ep00_introduction", "EP00_audio_sfx_master.wav")
FINAL_OUTPUT = os.path.join(PREVIEWS_DIR, "EP00_Introduction_V3_2_preview.mp4")
...
BEATS = [
    {
        ...
        "duration": 14.70,
        "raw_avi": "/tmp/beat01_v3_2.avi",
        "mp4": os.path.join(PREVIEWS_DIR, "EP00_Beat01_V3_2.mp4")
    },
    {
        "id": "beat02",
        "scene": "res://episodes/ep00_introduction/beats/Beat02_Identity.tscn",
        "duration": 16.84,
        "raw_avi": "/tmp/beat02_v3_2.avi",
        "mp4": os.path.join(PREVIEWS_DIR, "EP00_Beat02_V3_2.mp4")
    },
    {
        "id": "beat03",
        "scene": "res://episodes/ep00_introduction/beats/Beat03_Struggle.tscn",
        "duration": 19.77,
        "raw_avi": "/tmp/beat03_v3_2.avi",
        "mp4": os.path.join(PREVIEWS_DIR, "EP00_Beat03_V3_2.mp4")
    },
    {
        "id": "beat04",
        "scene": "res://episodes/ep00_introduction/beats/Beat04_Hobbies.tscn",
        "duration": 26.41,
        "raw_avi": "/tmp/beat04_v3_2.avi",
        "mp4": os.path.join(PREVIEWS_DIR, "EP00_Beat04_V3_2.mp4")
    },
    {
        "id": "beat05",
        "scene": "res://episodes/ep00_introduction/beats/Beat05_RabbitHole.tscn",
        "duration": 27.46,
        "raw_avi": "/tmp/beat05_v3_2.avi",
        "mp4": os.path.join(PREVIEWS_DIR, "EP00_Beat05_V3_2.mp4")
    },
    {
        "id": "beat06",
        "scene": "res://episodes/ep00_introduction/beats/Beat06_ChannelVision.tscn",
        "duration": 9.31,
        "raw_avi": "/tmp/beat06_v3_2.avi",
        "mp4": os.path.join(PREVIEWS_DIR, "EP00_Beat06_V3_2.mp4")
    },
    {
        "id": "beat07",
        "scene": "res://episodes/ep00_introduction/beats/Beat07_Outro.tscn",
        "duration": 10.61,
        "raw_avi": "/tmp/beat07_v3_2.avi",
        "mp4": os.path.join(PREVIEWS_DIR, "EP00_Beat07_V3_2.mp4")
    }
]
...
def assemble_master():
    print("\n============================================================")
    print("  ASSEMBLING MASTER EPISODE 00 V3.2 WITH 48kHz MASTER AUDIO")
    print("============================================================")
    ...
    print(f"✓ Master V3.2 Output Created: {FINAL_OUTPUT} ({size_mb:.2f} MB)")
    return True

def extract_audit_frames():
    print("\n============================================================")
    print("  EXTRACTING KEY AUDIT FRAMES FOR VISUAL VERIFICATION (V3.2)")
    print("============================================================")
    ...
    audit_points = [
        ...
        ("07_b5_bridge_and_clock_clutter.png", "00:01:22.50"),
...
def main():
    print("============================================================")
    print("  NEMI EPISODE 00 V3.2 — MASTER ANIMATION RENDER PIPELINE")
    print("============================================================")
    ...
    print("\n============================================================")
    print("  EPISODE 00 V3.2 PREVIEW PRODUCTION COMPLETE!")
