...
[AudioConcatenator] (Contextual Pause Engine)
       ...
       │
       ▼
ANIMATION ASSET SYNC (nemi/animations/ep00_introduction/voiceover/)
```
...
.venv/bin/python tools/generate_nemi_voice.py \
  ...
  --anim-voiceover-dir nemi/animations/ep00_introduction/voiceover \
  --speaker sohee
```

### Generated Files
1. **Dialogue Segments**: `nemi/audio/nemi/intro/segments/001.wav` through `022.wav` (and synced to `nemi/animations/ep00_introduction/voiceover/segments/`).
2. **Master Voice Track**: `nemi/audio/nemi/intro/master/nemi_intro_voice_master.wav` (and synced to `nemi/animations/ep00_introduction/voiceover/voiceover.wav`). Duration: 2:05 (125.4s).
3. **Machine-Readable Timing**: `nemi/audio/nemi/intro/timing/nemi_intro_timing.json` (used by Godot subtitle and lipsync systems).
4. **Human-Readable Timing**: `nemi/audio/nemi/intro/timing/Nemi_Intro_Voice_Timing.md`.
5. **Provenance Metadata**: `nemi/audio/nemi/intro/metadata/voice_metadata.json`.
