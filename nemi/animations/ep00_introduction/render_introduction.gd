...
## Runs res://nemi/animations/ep00_introduction/introduction_scene.tscn and orchestrates movie capture.

const SceneResource = preload("res://nemi/animations/ep00_introduction/introduction_scene.tscn")
