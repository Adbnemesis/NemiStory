...
* **`<animation_id>_scene.tscn`**: Instantiates:
  1. `Nemi` (`res://nemi/characters/nemi/nemi.tscn`).
  2. `Camera2D` (`res://nemi/world/camera/StoryCamera2D.gd`).
  3. `DynamicBackground` (`res://nemi/world/backgrounds/DynamicBackground.gd`).
  4. `DoodleManager` (`res://nemi/world/doodles/DoodleManager.gd`).
  5. `Props` (`res://nemi/world/props/`).
