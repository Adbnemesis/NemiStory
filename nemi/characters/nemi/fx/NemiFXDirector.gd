...
const NemiFXAnchor = preload("res://nemi/characters/nemi/fx/NemiFXAnchor.gd")
const NemiFXElement = preload("res://nemi/characters/nemi/fx/NemiFXElement.gd")

# Element preload map
const FX_CLASSES := {
	"confusion": preload("res://nemi/characters/nemi/fx/elements/FXConfusion.gd"),
	"question": preload("res://nemi/characters/nemi/fx/elements/FXConfusion.gd"),
	"shock": preload("res://nemi/characters/nemi/fx/elements/FXShock.gd"),
	"shocked": preload("res://nemi/characters/nemi/fx/elements/FXShock.gd"),
	"embarrassment": preload("res://nemi/characters/nemi/fx/elements/FXEmbarrassment.gd"),
	"embarrassed": preload("res://nemi/characters/nemi/fx/elements/FXEmbarrassment.gd"),
	"blush": preload("res://nemi/characters/nemi/fx/elements/FXEmbarrassment.gd"),
	"nervous": preload("res://nemi/characters/nemi/fx/elements/FXNervous.gd"),
	"sweat": preload("res://nemi/characters/nemi/fx/elements/FXNervous.gd"),
	"anger": preload("res://nemi/characters/nemi/fx/elements/FXAnger.gd"),
	"angry": preload("res://nemi/characters/nemi/fx/elements/FXAnger.gd"),
	"stress": preload("res://nemi/characters/nemi/fx/elements/FXAnger.gd"),
	"excitement": preload("res://nemi/characters/nemi/fx/elements/FXExcitement.gd"),
	"excited": preload("res://nemi/characters/nemi/fx/elements/FXExcitement.gd"),
	"sparkles": preload("res://nemi/characters/nemi/fx/elements/FXExcitement.gd"),
	"realization": preload("res://nemi/characters/nemi/fx/elements/FXRealization.gd"),
	"idea": preload("res://nemi/characters/nemi/fx/elements/FXRealization.gd"),
	"lightbulb": preload("res://nemi/characters/nemi/fx/elements/FXRealization.gd"),
	"panic": preload("res://nemi/characters/nemi/fx/elements/FXPanic.gd"),
	"sad": preload("res://nemi/characters/nemi/fx/elements/FXSad.gd"),
	"relief": preload("res://nemi/characters/nemi/fx/elements/FXRelief.gd"),
	"sigh": preload("res://nemi/characters/nemi/fx/elements/FXRelief.gd"),
	"deadpan": preload("res://nemi/characters/nemi/fx/elements/FXDeadpan.gd"),
	"silence": preload("res://nemi/characters/nemi/fx/elements/FXDeadpan.gd"),
	"ellipsis": preload("res://nemi/characters/nemi/fx/elements/FXDeadpan.gd"),
	"attention": preload("res://nemi/characters/nemi/fx/elements/FXAttention.gd")
}

const FXAttentionScript = preload("res://nemi/characters/nemi/fx/elements/FXAttention.gd")
const FXDeadpanScript = preload("res://nemi/characters/nemi/fx/elements/FXDeadpan.gd")
