...
## Draw a bracket accent (facing_right = true flips to right bracket: '}')
func bracket(target_pos: Vector2, height: float = 60.0, duration: float = 0.20, facing_right: bool = false, style_preset: DoodleInstanceScript.StylePreset = DoodleInstanceScript.StylePreset.NORMAL, layer: DoodleInstanceScript.LayerOrder = DoodleInstanceScript.LayerOrder.IN_FRONT_OF_NEMI) -> DoodleInstance:
	var d := DoodleInstanceScript.new()
...
## Draw an animated heart accent
func heart(target_pos: Vector2, size: float = 30.0, duration: float = 0.22, style_preset: DoodleInstanceScript.StylePreset = DoodleInstanceScript.StylePreset.NORMAL, layer: DoodleInstanceScript.LayerOrder = DoodleInstanceScript.LayerOrder.IN_FRONT_OF_NEMI) -> DoodleInstance:
	var d := DoodleInstanceScript.new()
	d.doodle_type = DoodleInstanceScript.Type.HEART
	d.global_position = target_pos
	d.doodle_size = size
	d.style_preset = style_preset
	d.color_mode = color_mode
...
func direction_lines(target_pos: Vector2, length: float = 30.0, duration: float = 0.18, layer: DoodleInstanceScript.LayerOrder = DoodleInstanceScript.LayerOrder.IN_FRONT_OF_NEMI) -> DoodleInstance:
	var d := DoodleInstanceScript.new()
	d.doodle_type = DoodleInstanceScript.Type.DIRECTION_LINES
	d.global_position = target_pos
	d.doodle_size = length
	d.style_preset = DoodleInstanceScript.StylePreset.NORMAL
	d.color_mode = color_mode
...
func mini(illustration_name: String, target_pos: Vector2, size: float = 36.0, duration: float = 0.28, style_preset: DoodleInstanceScript.StylePreset = DoodleInstanceScript.StylePreset.NORMAL, layer: DoodleInstanceScript.LayerOrder = DoodleInstanceScript.LayerOrder.IN_FRONT_OF_NEMI) -> DoodleInstance:
	...
	match illustration_name.to_lower():
		...
		"house": d.doodle_type = DoodleInstanceScript.Type.MINI_HOUSE
		"cat": d.doodle_type = DoodleInstanceScript.Type.MINI_CAT_HEAD
		"paw": d.doodle_type = DoodleInstanceScript.Type.MINI_PAW
		"milk": d.doodle_type = DoodleInstanceScript.Type.MINI_MILK_BOTTLE
...
## Draw a hand-drawn little house progressively
func house(target_pos: Vector2, size: float = 38.0, duration: float = 0.28, style_preset: DoodleInstanceScript.StylePreset = DoodleInstanceScript.StylePreset.NORMAL, layer: DoodleInstanceScript.LayerOrder = DoodleInstanceScript.LayerOrder.IN_FRONT_OF_NEMI) -> DoodleInstance:
	var d := DoodleInstanceScript.new()
	d.doodle_type = DoodleInstanceScript.Type.MINI_HOUSE
	d.global_position = target_pos
	d.doodle_size = size
	d.style_preset = style_preset
	d.color_mode = color_mode
...
## Draw a cute hand-drawn cat head with ears and whiskers
func cat_silhouette(target_pos: Vector2, size: float = 34.0, duration: float = 0.24, style_preset: DoodleInstanceScript.StylePreset = DoodleInstanceScript.StylePreset.NORMAL, layer: DoodleInstanceScript.LayerOrder = DoodleInstanceScript.LayerOrder.IN_FRONT_OF_NEMI) -> DoodleInstance:
	var d := DoodleInstanceScript.new()
	d.doodle_type = DoodleInstanceScript.Type.MINI_CAT_HEAD
	d.global_position = target_pos
	d.doodle_size = size
	d.style_preset = style_preset
	d.color_mode = color_mode
...
## Draw a paw step accent
func paw(target_pos: Vector2, size: float = 24.0, duration: float = 0.18, style_preset: DoodleInstanceScript.StylePreset = DoodleInstanceScript.StylePreset.NORMAL, layer: DoodleInstanceScript.LayerOrder = DoodleInstanceScript.LayerOrder.IN_FRONT_OF_NEMI) -> DoodleInstance:
	var d := DoodleInstanceScript.new()
	d.doodle_type = DoodleInstanceScript.Type.MINI_PAW
	d.global_position = target_pos
	d.doodle_size = size
	d.style_preset = style_preset
	d.color_mode = color_mode
...
## Draw a milk bottle
func milk_bottle(target_pos: Vector2, size: float = 32.0, duration: float = 0.22, style_preset: DoodleInstanceScript.StylePreset = DoodleInstanceScript.StylePreset.NORMAL, layer: DoodleInstanceScript.LayerOrder = DoodleInstanceScript.LayerOrder.IN_FRONT_OF_NEMI) -> DoodleInstance:
	var d := DoodleInstanceScript.new()
	d.doodle_type = DoodleInstanceScript.Type.MINI_MILK_BOTTLE
	d.global_position = target_pos
	d.doodle_size = size
	d.style_preset = style_preset
	d.color_mode = color_mode
