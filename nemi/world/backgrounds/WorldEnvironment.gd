...
func _draw() -> void:
	...
	draw_rect(Rect2(Vector2(-3000, -3000), Vector2(8000, 8000)), style.paper_bg_color)
...
func _draw_floor_line() -> void:
	var floor_pts := PackedVector2Array([Vector2(-1000.0, floor_y), Vector2(3000.0, floor_y)])
