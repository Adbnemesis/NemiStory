...
# Doodle and annotation ink accents (Default: Black / Near-Black Ink)
var doodle_accent_color: Color:
	get:
		# Black / dark ink default for authentic pen-on-paper storytelling
		return Color("#232026")

var doodle_red_accent_color: Color:
	get:
		return Color("#d64937")
