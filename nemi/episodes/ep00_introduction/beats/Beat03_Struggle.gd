...
const CutawayBananaPeelsClass = preload("res://nemi/episodes/ep00_introduction/cutaways/CutawayBananaPeels.gd")
...
func _run_beat3_choreography() -> void:
	...
	stylus_prop = preload("res://nemi/episodes/ep00_introduction/props/PropStylus.gd").new()
