...
const Episode00Subtitles = preload("res://nemi/episodes/ep00_introduction/Episode00Subtitles.gd")
const NemiDoodleDirectorClass = preload("res://nemi/world/doodles/NemiDoodleDirector.gd")
const DoodleInstanceClass = preload("res://nemi/world/doodles/DoodleInstance.gd")
...
func start_beat() -> void:
	...
	if is_standalone and voice_player and not OS.has_feature("movie"):
		if not voice_player.stream:
			voice_player.stream = load("res://nemi/animations/ep00_introduction/voiceover/voiceover.wav")
...
"""
	...
	typing_hands_prop = preload("res://nemi/episodes/ep00_introduction/props/PropTypingHands.gd").new()
	...
	clock_prop = preload("res://nemi/world/props/PropClock.gd").new()
	...
	bridge_prop = preload("res://nemi/episodes/ep00_introduction/props/PropVictorianBridge.gd").new()
