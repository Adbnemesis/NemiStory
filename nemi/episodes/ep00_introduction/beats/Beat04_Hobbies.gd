...
const PropCarEnvironmentClass = preload("res://nemi/episodes/ep00_introduction/cutaways/PropCarEnvironment.gd")
...
func _run_beat4_choreography() -> void:
	...
	dumbbell_prop = preload("res://nemi/episodes/ep00_introduction/props/PropDumbbell.gd").new()
