...
const BEAT_SCENES: Array[PackedScene] = [
	preload("res://nemi/episodes/ep00_introduction/beats/Beat01_Hook.tscn"),
	preload("res://nemi/episodes/ep00_introduction/beats/Beat02_Identity.tscn"),
	preload("res://nemi/episodes/ep00_introduction/beats/Beat03_Struggle.tscn"),
	preload("res://nemi/episodes/ep00_introduction/beats/Beat04_Hobbies.tscn"),
	preload("res://nemi/episodes/ep00_introduction/beats/Beat05_RabbitHole.tscn"),
	preload("res://nemi/episodes/ep00_introduction/beats/Beat06_ChannelVision.tscn"),
	preload("res://nemi/episodes/ep00_introduction/beats/Beat07_Outro.tscn")
]
...
func start_episode() -> void:
	...
	if master_audio:
		if not master_audio.stream:
			if ResourceLoader.exists("res://nemi/episodes/ep00_introduction/EP00_audio_sfx_master.wav"):
				master_audio.stream = load("res://nemi/episodes/ep00_introduction/EP00_audio_sfx_master.wav")
			else:
				master_audio.stream = load("res://nemi/animations/ep00_introduction/voiceover/voiceover.wav")
		master_audio.play(0.0)
	
	if debug_mode:
		debug_overlay = preload("res://nemi/episodes/ep00_introduction/Episode00DebugOverlay.gd").new()
