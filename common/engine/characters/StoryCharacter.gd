...
const HandDrawnMath = preload("res://common/engine/utils/HandDrawnMath.gd")
...
func _load_default_library() -> void:
	# Default Body Poses
	register_pose("neutral", load("res://nemi/assets/characters/storyteller/body/pose_neutral.png"))
	register_pose("crossed_arms", load("res://nemi/assets/characters/storyteller/body/pose_crossed_arms.png"))
	register_pose("gesturing", load("res://nemi/assets/characters/storyteller/body/pose_gesturing.png"))
	register_pose("recoil", load("res://nemi/assets/characters/storyteller/body/pose_recoil.png"))

	# Default Eye Textures
	register_eyes("neutral", load("res://nemi/assets/characters/storyteller/eyes/eyes_neutral.png"))
	register_eyes("squint", load("res://nemi/assets/characters/storyteller/eyes/eyes_squint.png"))
	register_eyes("shocked", load("res://nemi/assets/characters/storyteller/eyes/eyes_shocked.png"))
	register_eyes("deadpan", load("res://nemi/assets/characters/storyteller/eyes/eyes_deadpan.png"))
	register_eyes("sparkle", load("res://nemi/assets/characters/storyteller/eyes/eyes_sparkle.png"))
	register_eyes("blink", load("res://nemi/assets/characters/storyteller/eyes/eyes_blink.png"))

	# Default Mouth Textures
	register_mouth("open_o", load("res://nemi/assets/characters/storyteller/mouths/mouth_open_o.png"))
	register_mouth("smile", load("res://nemi/assets/characters/storyteller/mouths/mouth_smile.png"))
	register_mouth("blep", load("res://nemi/assets/characters/storyteller/mouths/mouth_blep.png"))
	register_mouth("smirk", load("res://nemi/assets/characters/storyteller/mouths/mouth_smirk.png"))
	register_mouth("flat", load("res://nemi/assets/characters/storyteller/mouths/mouth_flat.png"))

	# Default Details
	register_detail("blush", load("res://nemi/assets/characters/storyteller/details/detail_blush.png"))
	register_detail("sweat", load("res://nemi/assets/characters/storyteller/details/detail_sweat.png"))
	register_detail("exclamation", load("res://nemi/assets/characters/storyteller/details/detail_exclamation.png"))
